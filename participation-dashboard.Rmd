...
flexdashboard::valueBox(n_unique_tasks , icon = "fa-clipboard")
```
...
flexdashboard::valueBox(version, icon = "fa-git")
```
...
flexdashboard::valueBox(n_unique_tools, icon = "fa-toolbox")
```
...
```{r}
flexdashboard::valueBox(2, icon = "fa-building")
```
